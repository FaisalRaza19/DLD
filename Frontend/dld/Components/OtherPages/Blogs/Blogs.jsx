                ...
                <>
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {items.map((b) => (
                            <article
                                key={b.id}
                                className="group overflow-hidden rounded-xl border border-zinc-200 bg-white p-4 transition hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900"
                            >
                                <img
                    ...
                    <div className="mt-8 flex flex-wrap items-center justify-center gap-2">
                        <button
                            ...
                            className="rounded-md border disabled:cursor-not-allowed border-zinc-300 px-3 py-2 text-sm transition hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-900"
                            disabled={page <= 1}
                        >
                            Prev
                        </button>
                            ...
                            return (
                                <button
                                    ...
                                    className={`min-w-9 rounded-md px-3 py-2 text-sm ${active
                                        ...
                                        : "border border-zinc-300 text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-900"
                                        }`}
                                >
                                    {p}
                                </button>
                        ...
                        <button
                            ...
                            className="rounded-md border border-zinc-300 px-3 py-2 text-sm transition hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-900"
